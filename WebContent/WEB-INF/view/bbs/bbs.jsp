...
<body>
	...
	<div class="container" style="margin-top: 40px;">
			...
			<table class="table table-hover">
				...
				<tbody>
					<c:forEach var="se" items="${requestScope.AllBbs}" begin="0" end="9" step="1">
						...
						<tr>
							<td>${se.bbs_no}</td>
							<td><a href="/ITformation/board/view.do?bbs_no=${se.bbs_no}" style="color: blue">${se.bbs_tit}</a></td>
							<td>${se.bbs_user}</td>
							<td>${se.bbs_date}</td>
							<td>${se.bbs_lo}</td>
						</tr>
		...
		%>
		<div align="right">
			<a href="/ITformation/board/UnWrite.do" class="btn btn-primary">글쓰기</a>
		</div>
		<%
			} else {
		%>
	...
	<button type="button" class="btn btn-primary btn-lg"
		data-toggle="modal" data-target="#ConTModal">Launch demo
		modal</button>
