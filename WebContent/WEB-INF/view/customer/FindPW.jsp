...
<body>
	...
	<article class="container">
		...
		<div class="col-sm-6 col-md-offset-3">
			<form role="form" action="<%=url%>/customer/findPW.do" method="POST">
				...
				<div class="form-group">
					<label for="c_answer_type">비밀번호 찾을떄 필요한 질문입니다.</label>
					<select class="form-control" name="c_answer_type" id="c_answer_type">
				...
				<div class="form-group">
					<label for="c_answer">답변 입력 란 입니다.</label> <input type="text"
						class="form-control" name="c_answer" placeholder="질문에 대한 답변을 입력해주세요">
