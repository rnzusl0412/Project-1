...
<body>
	...
	<article class="container">
		...
		<div class="col-sm-6 col-md-offset-3">
			<form role="form" action="<%=url%>/customer/resetPW.do" method="POST">
				<div class="form-group">
					<label for="InputEmail">패스워드</label> <input type="text"
						class="form-control" name="c_pw" placeholder="비밀번호를 입력해주세요">
				</div>
				<div class="form-group">
					<label for="InputEmail">패스워드 확인</label> <input type="text"
