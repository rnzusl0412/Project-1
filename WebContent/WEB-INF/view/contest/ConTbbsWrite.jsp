					...
					<div class="row">
						...
						<div class="container">
							<div class="col-md-10 col-md-offset-3">
								...
								<form method="post" action="<%=url%>/ConTbbsWrite.do">
										...
										<tbody>
											<tr>
												<td colspan="4"><label for="bbsTitle"
													...
													placeholder="ex)Maritime ICT Innovation - 선상 통신 중심으로"
													name="pm_team" maxlength="50"></td>
											</tr>
											...
											<tr>
												<td colspan="4"><label for="bbsContents"
													class="font-weight-bold">프로젝트개요(소개 및 제안 배경)</label> <textarea
														...
														placeholder="EX)
□ 제안 배경 
·2020년까지 한국형 e-Navigtion 구축 사업을 해수부가 추진 중 
·2021년부터 항만물류가 고려된 스마트 자율운항 선박 사업 추진 예정 
·기존 사업의 현황을 파악하고 국제 추세에 맞춘 항만물류 분야에서의 ICT 적용 아이디어 도출 
□ 주요 내용 
·스마트 자율운항 선박 추진 현황 파악 
  - 스마트 자율운항 선박 개념 이해 "
														name="pm_primary" maxlength="2048" style="height: 350px;"></textarea></td>
											</tr>
											<tr>
												<td colspan="4"><label for="bbsContents"
													class="font-weight-bold">주요기능 및 예상 결과물</label> <textarea
														class="form-control" id="bbsContents"
														placeholder="EX)
·세미나 등 미팅 결과물 개별 보고서 (개별 4건) 
·최종 결과물로 항만물류에 ICT 적용 아이디어 각 1건"
														name="pm_function" maxlength="1000" style="height: 150px;"></textarea></td>
											</tr>
											<tr>
												<td colspan="4"><label for="bbsContents"
													class="font-weight-bold">기대효과 및 활용분야</label> <textarea
														class="form-control" id="bbsContents"
														placeholder="EX)
- 국가적으로 e-Navigation 사업과 스마트 자율운항 선박 사업이 계속 진행될 예정이므로 현황 파악을 통한 인사이트 도출 가능 
- 이를 기반으로 취업과 활용 가능 
- 항만물류 및 기본 통신 인프라 도메인 파악을 통한 아이디어 도출 "
														name="pm_effect" maxlength="1000" style="height: 150px;"></textarea></td>
											</tr>
											<tr>
												<td colspan="4"><label for="bbsContents"
...
- 통신 인프라를 기반으로 빅데이터 등 응용 기술"
											...
											<tr>
												<td colspan="4"><label for="bbsFile">첨부 파일</label> <input
													...
													placeholder="첨부 파일" name="pm_file" maxlength="50"></td>
											</tr>
										</tbody>
									</table>
