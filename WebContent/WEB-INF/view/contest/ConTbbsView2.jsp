								...
								<table class="table table-hover"
									...
									<thead align="center">
										<tr>
											<th colspan="2" style="background-color: #f8f8fa;">
												<h4>Maritime ICT Innovation - 선상 통신 중심으로"</h4>
											</th>
										</tr>
									</thead>
									...
									<tbody>
										<tr>
											...
											<td><span class="font-weight-light">ex)
													2019-04-05</span>
										</tr>
										<tr>
											<td><span class="font-italic">> 작성자</span></td>
											<td><span class="font-weight-light">ex) 이 경 선</span>
										</tr>
										<tr>
											<td><span class="font-italic">> 소속</span></td>
											<td><span class="font-weight-light">ex) 한국대학교</span>
										</tr>

										<tr>
											<td><span class="font-italic">> 소개 내용</span></td>
											<td><span class="font-weight-light">"EX) 안녕하세요 저는
													한국대학교 3학년 재학중인 최땡입니다. Frontend 개발경력 2년있구요 앞으로 열심히 개발해
													나가겠습니다. "</span>
										</tr>
