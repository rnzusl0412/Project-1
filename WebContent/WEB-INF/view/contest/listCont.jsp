...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="cont.entity.*, java.util.*"%>
	...
	<div class="container" style="margin-top: 40px;">
		<div class="row">
			<table class="table table-hover">
				...
				<tbody>
					<c:forEach var="se" items="${requestScope.listCont}">
						<tr>
						<tr>
							<td>${se.co_no}</td>
							<td>${se.co_name}</td>
							<td>${se.co_st}</td>
							<td>${se.co_end}</td>
							<td><a href="/ITformation/admin/deleteCont.do?co_no=${se.co_no}">삭제</a></td>
							<td><a href="/ITformation/admin/updateCont.do?co_no=${se.co_no}">수정</a></td>
						</tr>
					</c:forEach>
