...
<body>
	...
	<div class="col-md-6 col-md-offset-3">
		<form action="/ITformation/admin/updateCont.do?co_no=${ContEntity.co_no}" method="post">
			<h5>관리자 전용 입력창</h5>
			<div class="form-group">
				<label for="inputMobile">공모전 이름</label> <input type="tel" value="${ContEntity.co_name}"
					class="form-control" name="co_name" placeholder="공모전 이름을 입력하세요">
			</div>
			<div class="form-group">
				<label for="inputMobile">공모전 상세정보</label> <input type="tel" value="${ContEntity.co_exp}"
					class="form-control" name="co_exp" placeholder="공모전 이름을 입력하세요">
			</div>
			<div class="form-group">
				<label for="inputMobile">공모전 시작일</label> <input type="tel" value="${ContEntity.co_st}"
					class="form-control" name="co_st" placeholder="공모전 이름을 입력하세요">
			</div>
			<div class="form-group">
				<label for="inputMobile">공모전 종료일</label> <input type="tel" value="${ContEntity.co_end}"
					class="form-control" name="co_end" placeholder="공모전 이름을 입력하세요">
			</div>
			<div class="form-group">
				<label for="inputMobile">공모전 URL</label> <input type="tel" value="${ContEntity.co_url}"
