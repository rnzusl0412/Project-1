	...
	<div class="d-flex" id="wrapper">
		...
		<div class="bg-light border-right" id="sidebar-wrapper">
			...
			<div class="list-group list-group-flush">
				<a href="/ITformation/Cont.do" class="list-group-item list-group-item-action bg-light">공모전 달력</a>
				<a href="/ITformation/getTeamBbs.do" class="list-group-item list-group-item-action bg-light">팀원모집</a>
...
<div class="container">
		<div class="col-md-10 col-md-offset-3">
			...
			<form method="post" action="<%=url%>/insertBbs.do">
				<table class="table table-hover"
					style="border: 1px solid #dddddd; margin-top: 40px;">
					<tbody>
						<tr>
							<td colspan="4"><label for="bbsTitle" class="font-weight-bold">제 목</label> <input
								type="text" id="bbsTitle" class="form-control"
								placeholder="ex) 공모전 경험있고 성실하게 하겠습니다."
								name="bbs_tit" maxlength="50"></td>
						</tr>
						<tr>
							<td colspan="4"><label for="bbsContents" class="font-weight-bold">자기소개(보유역량)</label>
								<textarea class="form-control" id="bbsContents"
									placeholder="EX)
-정보처리기사
- DB 설계 가능
- Frontend개발경력 2년
- backend 조금 할줄암.......etc"
									name="bbs_con" maxlength="1000" style="height: 300px;"></textarea></td>
						</tr>
