            ...
            <form method="post" action="">
             ...
             <tbody>
                  <tr>
                      ...
                      <input type="text" id="bbs_tit" class="form-control" name="bbs_tit" maxlength="50" value="${entity.bbs_tit}"></td>
                  </tr> 
                  <!--  세션받아서 readonly로 집어 넣을겨 -->
                   <tr>
                      <td>
                       <label for="UserName">작성자</label>
                      <input type="text" id="bbs_user" class="form-control" value="${entity.bbs_user}" readonly="readonly" name="bbs_user" maxlength="50"></td>
                  </tr>  
                  <tr>
                      <td>
                      <label for="bbsContents">글 내용</label>
                      <textarea class="form-control" id="bbs_con" name="bbs_con" maxlength="2048" style="height:350px;">${entity.bbs_con}</textarea></td>                
                  </tr>        
               </tbody>
              </table>
