			...
			<form method="post" action="<%=url%>/insertBbs.do">
					...
					<tbody>
						<tr>
							<td><label for="bbsTitle">글 제목</label> <input type="text"
								id="bbsTitle" class="form-control" placeholder="글 제목"
								name="bbs_tit" maxlength="50"></td>
						</tr>
						<!--  세션받아서 readonly로 집어 넣을겨 -->
						<tr>
							<td><label for="UserName">작성자</label> <input type="text"
								id="bbsTitle" class="form-control" placeholder=<%=userID %> readonly="readonly"
						...
						<tr>
							<td><label for="bbsContents">글 내용</label> <textarea
									...
									name="bbs_con" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
				...
				<div align="right">
					<input type="submit" class="btn btn-primary pull-right"
						value="작성완료"> <!-- 누르면 작성을 완료하시겠습니까? 나오게끔 -->
				</div>
			</form>
		</div>
	</div>
