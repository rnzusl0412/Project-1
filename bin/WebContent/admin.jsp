		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
						...
						<form method="get" action="/ITformation/login.do">
							<div class="form-group row">
								...
								<div class="col-md-3" align="center">
									<button type="submit" class="btn btn-primary btn-lg" style="height: 95px">Login</button>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary" href="/ITformation/customer/input.do" role="button">회원가입</a>
				</div>
			</div>
		</div>
	</div>
